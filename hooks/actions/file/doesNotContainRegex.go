...
func (a *DoesNotContainRegex) Run(action *config.Action) error {
...
func NewDoesNotContainRegex(appIO io.IO, conf *config.Configuration, repo *git.Repository) hooks.Action {
